...
LIVIDMUI_DLG::LIVIDMUI_DLG( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	dmColorOptionsCustom_SpinCtrlDouble1->SetDigits( 0 );
	...
	dmColorOptionsCustom_SpinCtrlDouble2->SetDigits( 0 );
	...
	dmColorOptionsCustom_SpinCtrlDouble3->SetDigits( 0 );
	...
	dmColorOptionsCustom_SpinCtrlDouble4->SetDigits( 0 );
	...
	dmColourOptionsSliding_ColourAtShallowestLevelOfInterest_spinCtrlDouble->SetDigits( 0 );
	...
	dmColourOptionsSliding_DeepestLevelOfInterest_spinCtrlDouble->SetDigits( 0 );
	...
	dmColourOptionsTwoColours_DividingDepth_spinCtrlDouble = new wxSpinCtrlDouble( dmColourOptionsTwoColours_Panel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, -10000, 10, -25, 1 );
	dmColourOptionsTwoColours_DividingDepth_spinCtrlDouble->SetDigits( 0 );
	...
	dmWaterLevel_CurrentWaterLevel_spinCtrlDouble->SetDigits( 0 );
	...
	dmWaterLevel_VerticalReferenceSystemOffset_spinCtrlDouble->SetDigits( 0 );
