...
class LIVIDMUI_DLG : public wxDialog
{
	...
	protected:
		...
		wxPanel* dmDepthProfile_Panel;
		wxStaticText* dmChooseRoute_Label;
		wxFilePickerCtrl* dmDepthProfile_RouteFile_filePicker;
		wxStaticText* dmDepthProfileCSV_Label;
		wxFilePickerCtrl* dmDepthProfile_DpFile_filePicker;
		wxButton* dmGenerateDepthProfile_Button;
		...
		virtual void OnGenerateDepthProfile( wxCommandEvent& event ) { event.Skip(); }
